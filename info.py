...
REQ_CHANNEL_1 = environ.get("REQ_CHANNEL_1", "-1001739853003")
REQ_CHANNEL_1 = int(REQ_CHANNEL_1) if REQ_CHANNEL_1 and id_pattern.search(REQ_CHANNEL_1) else None

REQ_CHANNEL_2 = environ.get("REQ_CHANNEL_2", "-1001826892892")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bbkott6:bbnet@cluster0.lptvifi.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+SyZ6VqBQtrNjYjVl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+yc8XohZhJ84yZmY1')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001553475113'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MvM_Links')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>File Name:</b> <code>{file_name}</code> <b> \n \n ✯  ━━━━━  ✧  ━━━━━  ✯ \n
Uploaded by : @MovieHub_mho \n
Group : @MovieHubGroups \n
Backup : @MovieHubbackups </b>")
